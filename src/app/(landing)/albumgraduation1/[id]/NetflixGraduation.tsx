      ...
      <div className="mx-auto bg-black max-w-[440px] h-full px-4 relative">
        ...
        <div className="flex flex-col gap-y-2 mb-3">
          <NetflixButton
            ...
            {dayjs(parsedData.llm_generated.graduationDate).format('D MMMM YYYY')}
          </NetflixButton>
        ...
        <div className="flex flex-col items-start gap-y-3 text-white mb-3">
          ...
          <p className={showFullSynopsis ? "text-lg geist-font" : "text-lg geist-font line-clamp-3"}>
