...
const NetlfixWeddingPage = () => {
  ...
  const weddingData = {
    ...
    weddingPlace: "Kediaman Mempelai Wanita, Jl. Kalilom Lor Indah Gang Matahari No.100",
    weddingCity: "Surabaya",
    mapEmbedUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253840.49131625626!2d106.66470603628709!3d-6.2297209292163895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta%2C%20Daerah%20Khusus%20Ibukota%20Jakarta!5e0!3m2!1sid!2sid!4v1752330835231!5m2!1sid!2sid",
    storyDescription: "Dalam perjalanan hidup yang penuh takdir dan waktu, Salsa dan Luqman dipertemukan di saat yang tepat—ketika hati telah mantap dan langkah siap untuk berjalan bersama. Kini, keduanya bersiap melangkah menuju babak baru: sebuah ikatan suci bernama pernikahan.",
    quoteText: "\"Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan untukmu pasangan dari jenismu sendiri agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang…\"",
    ...
    episodes: [
      {
        ...
        duration: "26m 10s",
        description: "Yohan dan Alya pertama kali bertemu sebagai rekan kerja di kantor yang sama. Kegiatan-kegiatan kecil kantor yang sering melibatkan orang-orang didala."
      },
      {
        number: 2,
    ...
    galleryImages: Array(6).fill(null).map((_, index) => ({
    ...
    wishes: [
      ...
      },
      {
        ...
        message: "Selamatt couple mia1!! Semoga sakinah mawaddah warahmah aamiinnnnn",
      ...
      <div className="mx-auto bg-black max-w-[440px] h-full px-4">
        ...
        <div className="flex flex-col gap-y-3 items-start mb-3">
          <div className="flex items-center gap-x-2">
            <Image src="/Nikahfix.svg" width={10} height={18} alt="netflix logo" />
            <span className="text-[#A3A1A1] text-xs">DOCUMENTER</span>
          </div>
          <div className="flex flex-col gap-y-1 items-start">
            <h1 className="font-bold text-2xl text-white geist-font">{weddingData.coupleNames}</h1>
            <p className="text-base text-white geist-font">{weddingData.subtitle}</p>
          </div>
          <div className="flex items-center gap-x-2">
            <Image src="/Top10Icon.svg" width={20} height={21} alt="top 10 logo" />
            <h2 className="text-[#D1D5DB] text-xl geist-font">Best Wedding this Entire Life</h2>
          </div>
          <div className="flex items-center gap-x-2 text-white">
            <span className="text-[#22C55E] font-medium text-base geist-font">100% match</span>
            ...
            <span className="text-base geist-font">{weddingData.weddingTime} - Drop</span>
            <Image width={20} height={20} alt="4k full hd icon" src='/4KIcon.svg' />
            <Image width={20} height={20} alt="4k full hd icon" src='/HDIcon.svg' />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-y-2 mb-3">
          <NetflixButton
            ...
            icon={<Image src='CalendarIcon.svg' width={20} height={20} alt="Calendar Icon" />}
          >
          ...
          <NetflixButton
            variant="secondary"
            className="!px-6 !py-3 !h-fit"
            icon={<Image src='LocationIcon.svg' width={20} height={20} alt="Location Icon" />}
          >
            The Wedding Venue
          </NetflixButton>
        </div>
        ...
        <div className="flex flex-col gap-y-3 text-white mb-3">
          ...
          <blockquote className="border-l-4 border-[#4B5563] pl-5 geist-font text-[#9CA3AF] text-base geist-font">
            <p className="geist-font">{weddingData.quoteText}
              <span className="font-bold block geist-font">{weddingData.quoteSource}</span>
            </p>
          </blockquote>
        </div>
        ...
        <div className="flex flex-col items-start gap-y-3 mb-3">
          <SectionHeader
            title="Episode"
            subtitle="The Story of Our Love"
          />
        ...
        <div className="flex flex-col items-start gap-y-3 w-full mb-3">
          <SectionHeader
            ...
            rightElement={<Image width={30} height={30} alt="Info icon" src='/InfoIcon.svg' />}
          />
