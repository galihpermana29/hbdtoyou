...
const FirstTemplate = ({ data }: FirstTemplateProps) => {
  return (
    <div
      id="first-template"
      className="w-[1080px] mx-auto h-[1920px] bg-black overflow-hidden relative">
        ...
        <div className="flex flex-col w-full absolute gap-y-[35px] px-12 py-6 top-[794px]">
          <div className="flex flex-col items-center justify-center gap-y-5">
            <div className="flex flex-col gap-y-2 text-center">
              ...
              <p className="geist-font font-normal text-[24px] text-white">
                {data?.llm_generated?.subtitle}
              </p>
            </div>
      ...
      <p className="geist-font font-bold text-[40px] leading-8 text-white px-12 absolute top-[1186px]">
        Our Gallery
      </p>
      <div className="flex items-center gap-x-6 w-fit left-1/2 -translate-x-1/2 right-1/2 absolute top-[1262px]">
        {data?.images?.map((image: string, index: number) => (
          <div
            key={index}
            className="w-[235px] h-[368px] relative rounded-xl overflow-hidden bg-[#232323]">
