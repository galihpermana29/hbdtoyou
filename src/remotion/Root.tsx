...
import { Composition, registerRoot, AbsoluteFill, useCurrentFrame, useVideoConfig, Img } from 'remotion';
...
// Inline ScrapbookComposition to avoid import issues in serverless
const ScrapbookComposition: React.FC<ScrapbookProps> = ({
  pages,
  coverImage,
  backCoverImage,
}) => {
