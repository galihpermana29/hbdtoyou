 ...
 *
 * Nothing is published from here, and nothing is fetched. Publishing happened on
 * the step before, which is what carried the couple here; this screen says what
 * they have just done and shows them the address the invitation now answers at,
 * composed from its slug.
 *
...
export interface PublishedStepProps {
   ...
   *
   * Null is what somebody who never saved gets - a visitor with no account, who
   * had no invitation to publish - and what a couple gets when the read that
   * would have learned the slug did not come back. The box holding the link is
   * then not drawn at all, rather than drawn around nothing: an empty address
   * field with a Copy action beside it would be offering to copy something that
   * is not there.
   */
