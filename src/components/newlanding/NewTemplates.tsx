          ...
          <div className="py-[30px] md:py-[90px] flex flex-col text-center items-center mx-auto max-w-6xl 2xl:max-w-7xl px-[20px] min-h-screen ">
            <div>
              ...
              <p className="text-[16px] md:text-[20px] max-w-[768px] mx-auto font-[400] leading-[30px] text-[#7B7B7B] mt-[24px] mb-[48px]">
                ...
                Netflix, Spotify. And celebrate happy moments with a very
                special gift.
              </p>
      ...
      <Reveal>
        <div className="mx-auto max-w-6xl 2xl:max-w-7xl px-[20px] min-h-screen mt-[90px]">
          <div className="max-w-[768px]">
            ...
            <p className="text-[#7B7B7B] text-[16px] md:text-[20px] font-[400] mt-[20px]">
              From designing your special message, uploading your photos
              together, and choosing your favorite song, you can create your own
              special message gift.
            </p>
          </div>
