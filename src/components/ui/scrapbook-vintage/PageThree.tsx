...
import page1Frame from '@/assets/scrapbook2/page4.png';
import texture from '@/assets/scrapbook2/cover4.jpg';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {[0, 1, 2].map((frameIndex) => (
              <div
                ...
                <h3 className="font-medium mb-3">Frame {frameIndex + 1}</h3>
                {images[frameIndex] ? (
...
export default PageThreeVintageBook;
