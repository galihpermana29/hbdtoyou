...
import imageFrame from '@/assets/scrapbook2/page1.png';
import texture from '@/assets/scrapbook2/cover.jpg';
import { downloadCanvasAsImage } from '../scrapbook/utils/scrapbookUtils';

interface CoverVintagerBookProps {
  userImage?: string;
...
const CoverVintagerBook = ({
  userImage,
  canvasRef: externalCanvasRef,
}: CoverVintagerBookProps) => {
...
export default CoverVintagerBook;
